    ...
    <main>
        <section class="hero-section">
            <article class="hero-texto">
                <h2 class="hero-titulo">Domina tu dinero, asegura tu futuro</h2>
                <p class="hero-parrafo">
                    La herramienta definitiva para tomar el control de tus ingresos y gastos diarios. Organiza tu
                    presupuesto para pasajes, alimentación y proyectos sin complicaciones.
                </p>

                <div class="hero-imagen">
                    <div class="card floating-card card-destacada">
                        <header class="card-top">
                            <div class="icon-box icon-emerald">
                                <span class="material-symbols-outlined">account_balance</span>
                            </div>
                            <span class="badge badge-emerald">Ahorro Activo</span>
                        </header>
                        <p class="card-titulo">Fondo para el Semestre</p>
                        <p class="card-valor texto-primario">$850.000</p>
                        <div class="progress-container mt-4">
                            <div class="progress-bar-bg" style="background-color: #f1f5f9;">
                                <div class="progress-fill" style="width: 85%; background-color: var(--color-primario);">
                                </div>
                            </div>
                            <span style="color: var(--texto-secundario);">85%</span>
                        </div>
                    </div>
                </div>
            </article>
            ...
            <div class="auth-wrapper">
                ...
                <article id="tarjeta-registro" class="card login-card" style="display: none;">
                    ...
                    <footer class="login-footer">
                        <p>¿Ya tienes cuenta? <a href="#" id="btn-ir-login" class="link-primario">Inicia Sesión</a></p>
                    </footer>
                </article>
        ...
        <section id="beneficios" class="features-section">
            ...
            <div class="grid-tarjetas container-features">
                <article class="card text-center">
                    <div class="icon-box icon-blue mb-4 feature-icon"><span
                            class="material-symbols-outlined">donut_small</span></div>
                    <h3 class="feature-title">Análisis Visual</h3>
                    <p class="feature-desc">Entiende en qué se va tu dinero con gráficos fáciles de leer. Identifica tus
                        gastos hormiga al instante.</p>
                </article>

                <article class="card text-center card-destacada">
                    <div class="icon-box icon-primary mb-4 feature-icon"><span
                            class="material-symbols-outlined">target</span></div>
                    <h3 class="feature-title">Metas Claras</h3>
                    <p class="feature-desc">Establece objetivos de ahorro y mira cómo tu progreso avanza día a día de
                        forma automática.</p>
                </article>

                <article class="card text-center">
                    <div class="icon-box icon-emerald mb-4 feature-icon"><span
                            class="material-symbols-outlined">receipt_long</span></div>
                    <h3 class="feature-title">Gestión de Deudas</h3>
                    <p class="feature-desc">Registra lo que debes y lo que te deben. Mantén un historial impecable de
                        tus compromisos.</p>
                </article>
            </div>
        </section>
