...
<head>
  ...
  <link rel="stylesheet" href="./css/dashboard.css?v=1.0.0" />

  <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  <script type="module" src="./js/dashboard.js?v=1.0.0"></script>
</head>
    ...
    <header class="app-header">
      <div class="view-info">
        ...
        <p class="view-description">
          Hola,. Aquí tienes el resumen de hoy.
        </p>
      </div>
      ...
      <form class="formulario" id="form-movimiento">
        ...
        <div class="modal-form-group">
          ...
          <div class="icon-selector-trigger">
            ...
            <div class="icon-dropdown-menu" id="icon-dropdown-menu">
