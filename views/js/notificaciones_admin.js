...
export async function enviarBienvenidaSiNecesario(uid, nombre) {
    try {
        ...
        await crearNotificacion(uid, {
            titulo: `Te damos la bienvenida al panel de administración, ${nombre}! 🛡️`,
            mensaje: `Nos alegra que estés aquí. Desde este panel podrás gestionar usuarios, configurar alertas del sistema y asegurar el correcto funcionamiento de FinanzaPro.`,
            tipo: 'info'
        });
    } catch (e) {
